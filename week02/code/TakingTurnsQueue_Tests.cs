...
public class TakingTurnsQueueTests
{
    ...
    // Assert.AreEqual FAIL. Expected Bob, but got Sue. 
    // This is because the code was inserting people at the beginning the queue (insert[0]) instead of the end of the queue (add).
